    ...
    box-sizing: border-box;"></div>
                                                <div class="cards streak-card"
                                                    ...
                                                    <h2 style="margin-top: 20px;box-sizing: border-box;">
                                                        Streak : <%= request.getAttribute("streak") %>
                                                    </h2>
                                                </div>
                                            ...
                                            <Section class="profile" style="justify-content: center;">
                                                <div class="cards consistency-card">
                                                    ...
                                                    <span>
                                                        <%= request.getAttribute("activeDays")%> active days in last 30
                                                            days
                                                    </span>
            ...
            %>
                                                    ...
                                                    var options = {
                                                        ...
                                                        legend: 'none',
                                                        // Makes the chart expand to fill the container block completely
                                                    ...
                                                    // EXTRA FIX: Redraws the chart seamlessly whenever the window resizes
